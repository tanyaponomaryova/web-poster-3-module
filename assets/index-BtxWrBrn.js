...
void main() {
    ...
    `}var Fd=document.getElementById(`grid-overlay`),Id=document.getElementById(`v1`),Ld=document.getElementById(`v2`),Rd=document.getElementById(`h1`),zd=document.getElementById(`h2`),Bd=-.14,Vd=.12,Hd=.2,Ud=1.1,Wd=3.2;function Gd(){Fd.setAttribute(`viewBox`,`0 0 ${window.innerWidth} ${window.innerHeight}`)}var Kd={s1:0,s2:0,s3:0};function qd(){let e=document.querySelectorAll(`.section`);Kd.s1=e[0].offsetTop,Kd.s2=e[1].offsetTop,Kd.s3=e[2].offsetTop}function Jd(e,t,n){return e+(t-e)*n}function Yd(){let e=window.innerWidth,t=window.innerHeight,n=e/2,r=t/2,i=window.scrollY;Pd(i);let a=Kd.s2-Kd.s1,o=a>0?(i-Kd.s1)/a:0;o=Math.min(1,Math.max(0,o));let s=Kd.s3-Kd.s2,c=s>0?(i-Kd.s2)/s:0;c=Math.min(1,Math.max(0,c));let l,u;i<Kd.s2?(l=Jd(Bd,Vd,o),u=Jd(Ud,1,o)):(l=Jd(Vd,Hd,c),u=Jd(1,Wd,c));let d=[-e/6,e/6],f=[-t/6,t/6],p=d.map(e=>n+e*u),m=f.map(e=>r+e*u);function h(i){return`M ${i} 0 Q ${i+l*(i<n?-1:1)*e} ${r} ${i} ${t}`}function g(i){let a=i+l*(i<r?-1:1)*t;return`M 0 ${i} Q ${n} ${a} ${e} ${i}`}Id.setAttribute(`d`,h(p[0])),Ld.setAttribute(`d`,h(p[1])),Rd.setAttribute(`d`,g(m[0])),zd.setAttribute(`d`,g(m[1]))}var Xd=!1;function Zd(){Xd||=(requestAnimationFrame(()=>{Yd(),Xd=!1}),!0)}window.addEventListener(`scroll`,Zd,{passive:!0}),window.addEventListener(`resize`,()=>{Gd(),qd(),Yd()}),window.addEventListener(`load`,()=>{qd(),Yd()}),Gd(),qd(),Yd();var Qd=document.getElementById(`video`),$d=document.getElementById(`cameraBtn`),ef=document.getElementById(`photoBtn`),tf=document.getElementById(`camera-section`),nf=document.getElementById(`cameraScreen`),rf=document.getElementById(`flash`),af=document.getElementById(`studio-canvas`),of=document.getElementById(`studio-backdrop`),sf=document.getElementById(`three-canvas`),cf=document.getElementById(`backgroundColorPanel`),lf=document.getElementById(`handScalePanel`),uf=null,df=!1,ff=null,pf=null,mf=null,hf=260,gf=1,_f=null,vf=null,yf=!1,bf=of.getContext(`2d`);function xf(e,t,n){return`hsl(${(e%360+360)%360}, ${t}%, ${n}%)`}function Sf(){let e=of.width,t=of.height;if(!e||!t)return;let n=e*.5,r=t*.38,i=Math.max(e,t)*.8,a=bf.createRadialGradient(n,r,0,n,r,i);a.addColorStop(0,xf(hf+15,85,72)),a.addColorStop(.55,xf(hf,80,55)),a.addColorStop(1,xf(hf-25,70,28)),bf.fillStyle=a,bf.fillRect(0,0,e,t)}function Cf(){let e=nf.getBoundingClientRect(),t=Math.min(window.devicePixelRatio||1,2);of.width=Math.round(e.width*t),of.height=Math.round(e.height*t),Sf()}document.addEventListener(`colorchange`,e=>{e.detail.target===`worldBackground`&&(hf=e.detail.color.hue,Sf())}),document.addEventListener(`valuechange`,e=>{e.detail.target===`handBeetleScale`&&(gf=e.detail.value)});var wf=null,Tf=null,Ef=null;function Df(){wf=new ru({canvas:af,alpha:!0,antialias:!0,preserveDrawingBuffer:!0}),wf.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),Tf=new fo(50,1,.05,100),Tf.position.set(0,1.3,4),Ef=new pu(Tf,af),Ef.enableDamping=!0,Ef.enablePan=!0,Ef.enableZoom=!0,Ef.minDistance=2,Ef.maxDistance=8,Ef.target.set(0,.3,0),Ef.update(),Of()}function Of(){let e=nf.getBoundingClientRect();e.width&&e.height&&(wf.setSize(e.width,e.height,!1),Tf.aspect=e.width/e.height,Tf.updateProjectionMatrix())}function kf(){_f=requestAnimationFrame(kf),pf&&(Ef.update(),wf.render(pf,Tf))}function Af(){_f===null&&!df&&pf&&kf()}function jf(){_f!==null&&(cancelAnimationFrame(_f),_f=null)}var Mf=new Fn,Nf=new Dn;Nf.visible=!1,Mf.add(Nf);var Pf=null,Ff;function If(){Pf=new ru({canvas:sf,alpha:!0,antialias:!0,preserveDrawingBuffer:!0}),Pf.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),Pf.setClearColor(0,0);let e=nf.getBoundingClientRect(),t=e.width/e.height||1;Ff=new _o(-t,t,1,-1,.01,100),Ff.position.z=10,Lf()}function Lf(){let e=nf.getBoundingClientRect();if(!e.width||!e.height)return;Pf.setSize(e.width,e.height,!1);let t=e.width/e.height;Ff.left=-t,Ff.right=t,Ff.top=1,Ff.bottom=-1,Ff.updateProjectionMatrix()}function Rf(){if(!Pf){vf=null;return}vf=requestAnimationFrame(Rf),Pf.render(Mf,Ff)}function zf(){vf===null&&Rf()}function Bf(){vf!==null&&(cancelAnimationFrame(vf),vf=null)}function Vf(){mf&&(Nf.attach(mf),Nf.visible=!1)}function Hf(){mf&&pf&&(pf.attach(mf),mf.position.set(0,0,0),mf.rotation.set(0,0,0),mf.scale.set(1,1,1))}function Uf({detail:e}){pf=e.scene,mf=e.model,Df(),If(),Sf(),Cf(),$d.disabled=!1,$d.textContent=`Включить камеру`,yf&&!df&&Af()}window.beetleModel&&window.beetleScene?Uf({detail:{scene:window.beetleScene,model:window.beetleModel}}):window.addEventListener(`beetle:ready`,Uf);function Wf(){Cf(),wf&&Of(),Pf&&Lf()}window.addEventListener(`resize`,Wf),`IntersectionObserver`in window?new IntersectionObserver(([e])=>{yf=e.isIntersecting,yf?(Wf(),df||Af()):(jf(),df&&qf())},{threshold:.05}).observe(tf):(yf=!0,Af());function Gf(e){tf.classList.toggle(`webcam-on`,e),cf.style.display=e?`none`:``,lf.style.display=e?``:`none`,$d.textContent=e?`Выключить камеру`:`Включить камеру`}$d.addEventListener(`click`,()=>{df?qf():Kf()});async function Kf(){if(!mf||!Pf){alert(`Модель жука ещё загружается, попробуйте через пару секунд.`);return}try{uf=await navigator.mediaDevices.getUserMedia({video:{facingMode:`user`,width:{ideal:1280},height:{ideal:720}},audio:!1}),Qd.srcObject=uf,await Qd.play(),df=!0,Gf(!0),jf(),Vf(),zf(),Jf()}catch(e){console.error(`Ошибка доступа к камере:`,e),alert(`Не удалось получить доступ к веб-камере. Проверьте разрешения браузера.`)}}function qf(){df&&(ff&&=(ff.stop(),null),uf&&=(uf.getTracks().forEach(e=>e.stop()),null),Qd.srcObject=null,df=!1,Gf(!1),Bf(),Nf.visible=!1,Hf(),yf&&Af())}function Jf(){let e=new Hands({locateFile:e=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${e}`});e.setOptions({maxNumHands:1,modelComplexity:1,minDetectionConfidence:.7,minTrackingConfidence:.7}),e.onResults(Yf),ff=new Camera(Qd,{onFrame:async()=>{df&&await e.send({image:Qd})},width:640,height:480}),ff.start()}function Yf(e){if(!e.multiHandLandmarks||!e.multiHandLandmarks.length){Nf.visible=!1;return}Nf.visible=!0;let t=e.multiHandLandmarks[0];tp(t,e.multiHandedness&&e.multiHandedness[0]?e.multiHandedness[0].label:`Right`),np(t[9])}function Xf(e,t){return new W(-(t.x-e.x),-(t.y-e.y),(t.z-e.z)*.5)}var Zf=new jt,Qf=new q,$f=new jt().setFromEuler(new ln(0,0,0)),ep=.25;function tp(e){let t=e[0],n=e[5],r=e[9],i=e[17],a=Xf(i,n).normalize(),o=Xf(t,r).normalize(),s=new W().crossVectors(a,o).normalize(),c=new W().crossVectors(s,a).normalize();Qf.makeBasis(a,s,c.clone().negate()),Zf.setFromRotationMatrix(Qf).multiply($f),Nf.quaternion.slerp(Zf,ep)}function np(e){let t=nf.getBoundingClientRect(),n=t.width,r=t.height,i=Qd.videoWidth,a=Qd.videoHeight;if(!i||!a)return;let o=Math.max(n/i,r/a),s=i*o,c=a*o,l=(s-n)/2,u=(c-r)/2,d=(1-e.x)*i,f=e.y*a,p=d*o-l,m=f*o-u,h=p/n,g=m/r,_=n/r,v=(h-.5)*2*_,y=-(g-.5)*2,b=e.z*.5;Nf.position.set(v,y+.05,b),Nf.scale.setScalar(gf)}ef.addEventListener(`click`,rp);function rp(){let e=nf.getBoundingClientRect(),t=Math.round(e.width),n=Math.round(e.height),r=document.createElement(`canvas`);r.width=t,r.height=n;let i=r.getContext(`2d`);if(df){if(!Qd.videoWidth)return;ip(i,t,n),i.drawImage(Pf.domElement,0,0,t,n)}else i.drawImage(of,0,0,t,n),i.drawImage(wf.domElement,0,0,t,n);ap(r),rf.classList.remove(`active`),rf.offsetWidth,rf.classList.add(`active`)}function ip(e,t,n){let r=Qd.videoWidth,i=Qd.videoHeight,a=Math.max(t/r,n/i),o=r*a,s=i*a,c=(t-o)/2,l=(n-s)/2;e.save(),e.translate(t,0),e.scale(-1,1),e.drawImage(Qd,t-c-o,l,o,s),e.restore()}function ap(e){e.toBlob(e=>{if(!e)return;let t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`beetle-photo-${new Date().toISOString().replace(/[:.]/g,`-`)}.png`,document.body.appendChild(n),n.click(),n.remove(),URL.revokeObjectURL(t)},`image/png`)}var op=new Fn;window.beetleScene=op;var sp=new ku,cp=null,lp=null,up=null,dp=null,fp=null,pp=null,mp=null,hp=null,gp=null;sp.load(`public/hero-scene.glb`,e=>{let t=e.scene;t.traverse(e=>{e.layers.set(1)}),cp=t.getObjectByName(`pencil`),lp=t.getObjectByName(`pencil-empty`),up=t.getObjectByName(`beetle-wings`),dp=t.getObjectByName(`star-1`),fp=t.getObjectByName(`star-2`),pp=t.getObjectByName(`hand`),mp=t.getObjectByName(`flower`),hp=t.getObjectByName(`brush-handle`),gp=t.getObjectByName(`bug-lab`),lp.userData.baseRotX=lp.rotation.x,lp.userData.baseRotY=lp.rotation.y,pp.userData.baseRotX=pp.rotation.x,pp.userData.baseRotY=pp.rotation.y,dp.userData.baseRotX=dp.rotation.x,dp.userData.baseRotY=dp.rotation.y,fp.userData.baseRotX=fp.rotation.x,fp.userData.baseRotY=fp.rotation.y,mp.userData.baseRotX=mp.rotation.x,mp.userData.baseRotY=mp.rotation.y,hp.userData.baseRotX=hp.rotation.x,hp.userData.baseRotY=hp.rotation.y,gp.userData.baseRotX=gp.rotation.x,gp.userData.baseRotY=gp.rotation.y,console.log(t),op.add(t)});var _p=document.querySelector(`.hero-canvas-wrapper`),vp={get width(){return _p.offsetWidth},get height(){return _p.offsetHeight}},yp=new fo(31,vp.width/vp.height,.05,100);op.add(yp),yp.layers.set(1);var bp=new ru({alpha:!0,antialias:!0,canvas:document.querySelector(`.hero-webgl`)});bp.setPixelRatio(Math.min(window.devicePixelRatio,2)),bp.setSize(vp.width,vp.height),bp.render(op,yp);var $=new Proxy({eyeShapeName:null,headShapeName:null,bodyShapeName:null,eyeShapeVariants:[{name:`Circle`,object:null},{name:`Star`,object:null},{name:`Heart`,object:null}],headShapeVariants:[{name:`Antennae`,object:null},{name:`Deer_Horns`,object:null},{name:`Rhino_Horns`,object:null}],bodyShapeVariants:[{name:`Body_Long`,object:null},{name:`Body_Medium`,object:null},{name:`Body_Short`,object:null}],wingShapeVariants:[{name:`Wings_Long`,object:null},{name:`Wings_Medium`,object:null},{name:`Wings_Short`,object:null}],eyeColor:null,bodyColor:null,brushColor:null},{set(e,t,n){let r=e[t];return e[t]=n,r!==n&&Cp(t,n,r),!0}});window.beetleOptions=$;function xp(e,t){e.forEach(e=>{e.object&&(e.object.visible=e.name===t)})}var Sp=null;function Cp(e,t,n){if(e===`eyeShapeName`)xp($.eyeShapeVariants,t);else if(e===`headShapeName`)xp($.headShapeVariants,t);else if(e===`bodyShapeName`){xp($.bodyShapeVariants,t);let e=$.bodyShapeVariants.findIndex(e=>e.name===t),n=$.wingShapeVariants[e];n&&(xp($.wingShapeVariants,n.name),Wp(n.name))}else if(e===`eyeColor`){let e=$.eyeShapeVariants[0].object;if(!e)return;e.material.emissive.set(t)}else if(e===`bodyColor`){if(!Sp)return;Sp.material.emissive.set(t)}}sp.load(`public/Beetles.glb`,e=>{let t=e.scene;op.add(t),console.log(t),Sp=t.getObjectByName(`Head`),t.getObjectByName(`White_Eye`),$.eyeShapeVariants.forEach(e=>{e.object=t.getObjectByName(e.name)}),$.headShapeVariants.forEach(e=>{e.object=t.getObjectByName(e.name)}),$.bodyShapeVariants.forEach(e=>{e.object=t.getObjectByName(e.name)}),$.wingShapeVariants.forEach(e=>{e.object=t.getObjectByName(e.name)}),$.eyeShapeName=$.eyeShapeVariants[0].name,$.headShapeName=$.headShapeVariants[0].name,$.bodyShapeName=$.bodyShapeVariants[0].name,$.bodyColor&&Cp(`bodyColor`,$.bodyColor),$.eyeColor&&Cp(`eyeColor`,$.eyeColor),window.beetleModel=t,window.dispatchEvent(new CustomEvent(`beetle:ready`,{detail:{scene:op,model:t}}))});var wp=document.getElementById(`canvas-buttons-wrapper`),Tp={get width(){return wp.offsetWidth},get height(){return wp.offsetHeight}},Ep=new fo(50,Tp.width/Tp.height,.05,100);op.add(Ep),Ep.position.z=-2.5,Ep.position.x=-2.5,Ep.position.y=3;var Dp=document.querySelector(`.webgl`),Op=new ru({alpha:!0,antialias:!0,canvas:Dp});Op.setPixelRatio(Math.min(window.devicePixelRatio,2)),Op.setSize(Tp.width,Tp.height),Op.render(op,Ep);var kp=new pu(Ep,Dp);kp.autoRotate=!0,kp.autoRotateSpeed=.8,kp.enableDamping=!0,kp.enablePan=!1,kp.target=new W(0,0,0),kp.enableZoom=!1,window.addEventListener(`resize`,()=>{Ep.aspect=Tp.width/Tp.height,Ep.updateProjectionMatrix(),yp.aspect=vp.width/vp.height,yp.updateProjectionMatrix(),Op.setSize(Tp.width,Tp.height),bp.setSize(vp.width,vp.height),console.log(`РЕСАЙЗ`)});var Ap=[{button:document.querySelector(`.anchored-button-eyes`),name:`Eyes`,position:new W(-.33,.71,-.96)},{button:document.querySelector(`.anchored-button-wings`),name:`Wings`,position:new W(-.52,.91,.25)},{button:document.querySelector(`.anchored-button-body-color`),name:`Body Color`,position:new W(-.58,.33,-.34)},{button:document.querySelector(`.anchored-button-head`),name:`Head`,position:new W(0,.53,-1.5)},{button:document.querySelector(`.anchored-button-body-shape`),name:`Body Shape`,position:new W(-.01,.99,1)}];function jp(){for(let e=0;e<Ap.length;e++){let t=Ap[e].position.clone();t.project(Ep);let n=(t.x*.5+.5)*Tp.width,r=(-t.y*.5+.5)*Tp.height;Ap[e].button.style.left=n+`px`,Ap[e].button.style.top=r+`px`}}var Mp=`#ff2d9e`,Np=10,Pp={Wings_Short:`/mask-wing-short.svg`,Wings_Medium:`/mask-wing-medium.svg`,Wings_Long:`/mask-wing-long.svg`},Fp=document.getElementById(`wingP5Container`),Ip=document.getElementById(`wingMaskOverlay`),Lp=document.querySelector(`.wing-clear-btn`),Rp,zp,Bp,Vp,Hp,Up=`#ededed`;function Wp(e){if(!Ip)return;let t=Pp[e];t&&(Ip.src=t)}function Gp(){Hp&&$.wingShapeVariants.forEach(e=>{e.object&&(e.object.material=Hp)})}function Kp(){Bp&&(Bp.background(Up),Vp&&(Vp.needsUpdate=!0))}function qp(){return Math.max(1,Math.min(Fp.offsetWidth,Fp.offsetHeight))}function Jp(){Vp&&Vp.dispose(),Vp=new ia(Bp.elt),Vp.flipY=!1,Vp.colorSpace=He,Vp.anisotropy=Op.capabilities.getMaxAnisotropy(),Vp.needsUpdate=!0,Hp=new Ur({map:Vp}),Gp()}function Yp(){if(!Fp||Rp)return;Rp=new e(e=>{e.setup=function(){let t=qp();zp=e.createCanvas(t,t),zp.parent(`wingP5Container`),Bp=e.createGraphics(t,t),Bp.background(Up),Jp()},e.draw=function(){e.image(Bp,0,0,e.width,e.height),e.mouseIsPressed&&e.mouseX>=0&&e.mouseX<=e.width&&e.mouseY>=0&&e.mouseY<=e.height&&(Bp.stroke($.brushColor||Mp),Bp.strokeWeight(parseFloat($.brushSize)||Np),Bp.line(e.pmouseX,e.pmouseY,e.mouseX,e.mouseY),Vp.needsUpdate=!0)}});function t(){if(!Rp||!Bp)return;let e=qp();if(e===Bp.width)return;let t=Rp.createGraphics(e,e);t.background(255),t.image(Bp,0,0,e,e),Bp.remove(),Bp=t,Rp.resizeCanvas(e,e),Jp()}`ResizeObserver`in window&&new ResizeObserver(t).observe(Fp)}Lp&&Lp.addEventListener(`click`,Kp),Yp(),window.addEventListener(`beetle:ready`,()=>{Gp();let e=$.bodyShapeVariants.findIndex(e=>e.name===$.bodyShapeName),t=$.wingShapeVariants[e];t&&Wp(t.name)});var Xp=null;function Zp(){Op.render(op,Ep),kp.update(),Xp=requestAnimationFrame(Zp),jp()}Zp();var Qp=0,$p=0,em=0,tm=0;window.addEventListener(`mousemove`,e=>{let t=_p.getBoundingClientRect();Qp=(e.clientX-t.left)/t.width*2-1,$p=(e.clientY-t.top)/t.height*2-1});var nm=yp.position.clone(),rm=.01,im=.2,am=null,om=Date.now();function sm(e,t){let n=e.userData.baseRotY+Qp*t,r=e.userData.baseRotX+$p*t;e.rotation.y+=(n-e.rotation.y)*.1,e.rotation.x+=(r-e.rotation.x)*.1}function cm(){bp.render(op,yp),am=requestAnimationFrame(cm);let e=Date.now(),t=e-om;om=e,cp.rotation.y+=.001*t,up.rotation.x=Math.sin(e*.003)*.07,dp.rotation.y=Math.sin(e*.005)*.3,fp.rotation.y=Math.sin(e*.005+1)*.3,pp.rotation.z=Math.sin(e*.001+1)*.05,sm(lp,im),sm(pp,im),sm(mp,im),sm(hp,im),sm(dp,im),sm(fp,im),sm(gp,im*3),em=Qp*rm,tm=-$p*rm,yp.position.x+=(nm.x+em-yp.position.x)*.1,yp.position.y+=(nm.y+tm-yp.position.y)*.1,yp.lookAt(0,0,-1)}cm();var lm=document.getElementById(`creation-section`);lm&&`IntersectionObserver`in window&&new IntersectionObserver(([e])=>{e.isIntersecting?Xp===null&&Zp():Xp!==null&&(cancelAnimationFrame(Xp),Xp=null)},{threshold:.05}).observe(lm);var um=document.getElementById(`hero-section`);um&&`IntersectionObserver`in window&&new IntersectionObserver(([e])=>{e.isIntersecting?am===null&&cm():am!==null&&(cancelAnimationFrame(am),am=null)},{threshold:.05}).observe(um);