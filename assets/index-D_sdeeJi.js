...
void main() {
    ...
    `}var Fd=document.getElementById(`grid-overlay`),Id=document.getElementById(`v1`),Ld=document.getElementById(`v2`),Rd=document.getElementById(`h1`),zd=document.getElementById(`h2`),Bd=-.14,Vd=.12,Hd=.2,Ud=1.1,Wd=3.2;function Gd(){Fd.setAttribute(`viewBox`,`0 0 ${window.innerWidth} ${window.innerHeight}`)}var Kd={s1:0,s2:0,s3:0};function qd(){let e=document.querySelectorAll(`.section`);Kd.s1=e[0].offsetTop,Kd.s2=e[1].offsetTop,Kd.s3=e[2].offsetTop}function Jd(e,t,n){return e+(t-e)*n}function Yd(){let e=window.innerWidth,t=window.innerHeight,n=e/2,r=t/2,i=window.scrollY;Pd(i);let a=Kd.s2-Kd.s1,o=a>0?(i-Kd.s1)/a:0;o=Math.min(1,Math.max(0,o));let s=Kd.s3-Kd.s2,c=s>0?(i-Kd.s2)/s:0;c=Math.min(1,Math.max(0,c));let l,u;i<Kd.s2?(l=Jd(Bd,Vd,o),u=Jd(Ud,1,o)):(l=Jd(Vd,Hd,c),u=Jd(1,Wd,c));let d=[-e/6,e/6],f=[-t/6,t/6],p=d.map(e=>n+e*u),m=f.map(e=>r+e*u);function h(i){return`M ${i} 0 Q ${i+l*(i<n?-1:1)*e} ${r} ${i} ${t}`}function g(i){let a=i+l*(i<r?-1:1)*t;return`M 0 ${i} Q ${n} ${a} ${e} ${i}`}Id.setAttribute(`d`,h(p[0])),Ld.setAttribute(`d`,h(p[1])),Rd.setAttribute(`d`,g(m[0])),zd.setAttribute(`d`,g(m[1]))}var Xd=!1;function Zd(){Xd||=(requestAnimationFrame(()=>{Yd(),Xd=!1}),!0)}window.addEventListener(`scroll`,Zd,{passive:!0}),window.addEventListener(`resize`,()=>{Gd(),qd(),Yd()}),window.addEventListener(`load`,()=>{qd(),Yd()}),Gd(),qd(),Yd();var Qd=document.getElementById(`camera-section`),$d=document.getElementById(`cameraScreen`),ef=document.getElementById(`video`),tf=document.getElementById(`cameraBtn`),nf=document.getElementById(`camera-on-icon`),rf=document.getElementById(`camera-off-icon`),af=document.getElementById(`photoBtn`),of=document.getElementById(`flash`),sf=document.getElementById(`studio-canvas`),cf=document.getElementById(`studio-backdrop`),lf=document.getElementById(`three-canvas`),uf=document.getElementById(`backgroundColorPanel`),df=document.getElementById(`handScalePanel`),ff=null,pf=!1,mf=null,hf=null,gf=null,_f=260,vf=1,yf=null,bf=null,xf=!1,Sf=cf.getContext(`2d`);function Cf(e,t,n){return`hsl(${(e%360+360)%360}, ${t}%, ${n}%)`}function wf(){let e=cf.width,t=cf.height;if(!e||!t)return;let n=e*.5,r=t*.38,i=Math.max(e,t)*.8,a=Sf.createRadialGradient(n,r,0,n,r,i);a.addColorStop(0,Cf(_f+15,85,72)),a.addColorStop(.55,Cf(_f,80,55)),a.addColorStop(1,Cf(_f-25,70,28)),Sf.fillStyle=a,Sf.fillRect(0,0,e,t)}function Tf(){let e=$d.getBoundingClientRect(),t=Math.min(window.devicePixelRatio||1,2);cf.width=Math.round(e.width*t),cf.height=Math.round(e.height*t),wf()}document.addEventListener(`colorchange`,e=>{e.detail.target===`worldBackground`&&(_f=e.detail.color.hue,wf())}),document.addEventListener(`valuechange`,e=>{e.detail.target===`handBeetleScale`&&(vf=e.detail.value)});var Ef=null,Df=null,Of=null;function kf(){Ef=new ru({canvas:sf,alpha:!0,antialias:!0,preserveDrawingBuffer:!0}),Ef.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),Df=new fo(50,1,.05,100),Df.position.set(-2.5,3,-3),Of=new pu(Df,sf),Of.enableDamping=!0,Of.enablePan=!0,Of.enableZoom=!0,Of.minDistance=2,Of.maxDistance=8,Of.target.set(0,.3,0),Of.update(),Af()}function Af(){let e=$d.getBoundingClientRect();e.width&&e.height&&(Ef.setSize(e.width,e.height,!1),Df.aspect=e.width/e.height,Df.updateProjectionMatrix())}function jf(){yf=requestAnimationFrame(jf),hf&&(Of.update(),Ef.render(hf,Df))}function Mf(){yf===null&&!pf&&hf&&jf()}function Nf(){yf!==null&&(cancelAnimationFrame(yf),yf=null)}var Pf=new Fn,Ff=new Dn;Ff.visible=!1,Pf.add(Ff);var If=null,Lf;function Rf(){If=new ru({canvas:lf,alpha:!0,antialias:!0,preserveDrawingBuffer:!0}),If.setPixelRatio(Math.min(window.devicePixelRatio||1,2));let e=$d.getBoundingClientRect(),t=e.width/e.height||1;Lf=new _o(-t,t,1,-1,.01,100),Lf.position.z=10,zf()}function zf(){let e=$d.getBoundingClientRect();if(!e.width||!e.height)return;If.setSize(e.width,e.height,!1);let t=e.width/e.height;Lf.left=-t,Lf.right=t,Lf.top=1,Lf.bottom=-1,Lf.updateProjectionMatrix()}function Bf(){if(!If){bf=null;return}bf=requestAnimationFrame(Bf),If.render(Pf,Lf)}function Vf(){bf===null&&Bf()}function Hf(){bf!==null&&(cancelAnimationFrame(bf),bf=null)}function Uf(){gf&&(Ff.attach(gf),Ff.visible=!1)}function Wf(){gf&&hf&&(hf.attach(gf),gf.position.set(0,0,0),gf.rotation.set(0,0,0),gf.scale.set(1,1,1))}function Gf({detail:e}){hf=e.scene,gf=e.model,kf(),Rf(),wf(),Tf(),tf.disabled=!1,xf&&!pf&&Mf()}window.beetleModel&&window.beetleScene?Gf({detail:{scene:window.beetleScene,model:window.beetleModel}}):window.addEventListener(`beetle:ready`,Gf);function Kf(){Tf(),Ef&&Af(),If&&zf()}window.addEventListener(`resize`,Kf),`IntersectionObserver`in window?new IntersectionObserver(([e])=>{xf=e.isIntersecting,xf?(Kf(),pf||Mf()):(Nf(),pf&&Yf())},{threshold:.05}).observe(Qd):(xf=!0,Mf());function qf(e){Qd.classList.toggle(`webcam-on`,e),uf.style.display=e?`none`:``,df.style.display=e?``:`none`,nf.style.display=e?`none`:``,rf.style.display=e?``:`none`}tf.addEventListener(`click`,()=>{pf?Yf():Jf()});async function Jf(){if(!gf||!If){alert(`Модель жука ещё загружается, попробуйте через пару секунд.`);return}try{ff=await navigator.mediaDevices.getUserMedia({video:{facingMode:`user`,width:{ideal:1280},height:{ideal:720}},audio:!1}),ef.srcObject=ff,await ef.play(),pf=!0,qf(!0),Nf(),Uf(),Vf(),Xf()}catch(e){console.error(`Ошибка доступа к камере:`,e),alert(`Не удалось получить доступ к веб-камере. Проверьте разрешения браузера.`)}}function Yf(){pf&&(mf&&=(mf.stop(),null),ff&&=(ff.getTracks().forEach(e=>e.stop()),null),ef.srcObject=null,pf=!1,qf(!1),Hf(),Ff.visible=!1,Wf(),xf&&Mf())}function Xf(){let e=new Hands({locateFile:e=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${e}`});e.setOptions({maxNumHands:1,modelComplexity:1,minDetectionConfidence:.7,minTrackingConfidence:.7}),e.onResults(Zf),mf=new Camera(ef,{onFrame:async()=>{pf&&await e.send({image:ef})},width:640,height:480}),mf.start()}function Zf(e){if(!e.multiHandLandmarks||!e.multiHandLandmarks.length){Ff.visible=!1;return}Ff.visible=!0;let t=e.multiHandLandmarks[0];rp(t,e.multiHandedness&&e.multiHandedness[0]?e.multiHandedness[0].label:`Right`),ip(t[9])}function Qf(e,t){return new W(-(t.x-e.x),-(t.y-e.y),(t.z-e.z)*.5)}var $f=new jt,ep=new q,tp=new jt().setFromEuler(new ln(0,0,0)),np=.25;function rp(e){let t=e[0],n=e[5],r=e[9],i=e[17],a=Qf(i,n).normalize(),o=Qf(t,r).normalize(),s=new W().crossVectors(a,o).normalize(),c=new W().crossVectors(s,a).normalize();ep.makeBasis(a,s,c.clone().negate()),$f.setFromRotationMatrix(ep).multiply(tp),Ff.quaternion.slerp($f,np)}function ip(e){let t=$d.getBoundingClientRect(),n=t.width,r=t.height,i=ef.videoWidth,a=ef.videoHeight;if(!i||!a)return;let o=Math.max(n/i,r/a),s=i*o,c=a*o,l=(s-n)/2,u=(c-r)/2,d=(1-e.x)*i,f=e.y*a,p=d*o-l,m=f*o-u,h=p/n,g=m/r,_=n/r,v=(h-.5)*2*_,y=-(g-.5)*2,b=e.z*.5;Ff.position.set(v,y+.05,b),Ff.scale.setScalar(vf)}af.addEventListener(`click`,ap);function ap(){let e=$d.getBoundingClientRect(),t=Math.round(e.width),n=Math.round(e.height),r=document.createElement(`canvas`);r.width=t,r.height=n;let i=r.getContext(`2d`);if(pf){if(!ef.videoWidth)return;op(i,t,n),i.drawImage(If.domElement,0,0,t,n)}else i.drawImage(cf,0,0,t,n),i.drawImage(Ef.domElement,0,0,t,n);sp(r),of.classList.remove(`active`),of.offsetWidth,of.classList.add(`active`)}function op(e,t,n){let r=ef.videoWidth,i=ef.videoHeight,a=Math.max(t/r,n/i),o=r*a,s=i*a,c=(t-o)/2,l=(n-s)/2;e.save(),e.translate(t,0),e.scale(-1,1),e.drawImage(ef,t-c-o,l,o,s),e.restore()}function sp(e){e.toBlob(e=>{if(!e)return;let t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`beetle-photo-${new Date().toISOString().replace(/[:.]/g,`-`)}.png`,document.body.appendChild(n),n.click(),n.remove(),URL.revokeObjectURL(t)},`image/png`)}var cp=new Fn;window.beetleScene=cp;var lp=new ku,up=null,dp=null,fp=null,pp=null,mp=null,hp=null,gp=null,_p=null,vp=null;lp.load(`/web-poster-3-module//hero-scene.glb`,e=>{let t=e.scene;t.traverse(e=>{e.layers.set(1)}),up=t.getObjectByName(`pencil`),dp=t.getObjectByName(`pencil-empty`),fp=t.getObjectByName(`beetle-wings`),pp=t.getObjectByName(`star-1`),mp=t.getObjectByName(`star-2`),hp=t.getObjectByName(`hand`),gp=t.getObjectByName(`flower`),_p=t.getObjectByName(`brush-handle`),vp=t.getObjectByName(`bug-lab`),dp.userData.baseRotX=dp.rotation.x,dp.userData.baseRotY=dp.rotation.y,hp.userData.baseRotX=hp.rotation.x,hp.userData.baseRotY=hp.rotation.y,pp.userData.baseRotX=pp.rotation.x,pp.userData.baseRotY=pp.rotation.y,mp.userData.baseRotX=mp.rotation.x,mp.userData.baseRotY=mp.rotation.y,gp.userData.baseRotX=gp.rotation.x,gp.userData.baseRotY=gp.rotation.y,_p.userData.baseRotX=_p.rotation.x,_p.userData.baseRotY=_p.rotation.y,vp.userData.baseRotX=vp.rotation.x,vp.userData.baseRotY=vp.rotation.y,console.log(t),cp.add(t)});var yp=document.querySelector(`.hero-canvas-wrapper`),bp={get width(){return yp.offsetWidth},get height(){return yp.offsetHeight}},xp=new fo(31,bp.width/bp.height,.05,100);cp.add(xp),xp.layers.set(1);var Sp=new ru({alpha:!0,antialias:!0,canvas:document.querySelector(`.hero-webgl`)});Sp.setPixelRatio(Math.min(window.devicePixelRatio,2)),Sp.setSize(bp.width,bp.height,!1),Sp.render(cp,xp);var Cp=null;new ResizeObserver(()=>{Cp!==null&&cancelAnimationFrame(Cp),Cp=requestAnimationFrame(()=>{xp.aspect=bp.width/bp.height,xp.updateProjectionMatrix(),Sp.setSize(bp.width,bp.height,!1),Cp=null})}).observe(yp);var $=new Proxy({eyeShapeName:null,headShapeName:null,bodyShapeName:null,eyeShapeVariants:[{name:`Circle`,object:null},{name:`Star`,object:null},{name:`Heart`,object:null}],headShapeVariants:[{name:`Antennae`,object:null},{name:`Deer_Horns`,object:null},{name:`Rhino_Horns`,object:null}],bodyShapeVariants:[{name:`Body_Long`,object:null},{name:`Body_Medium`,object:null},{name:`Body_Short`,object:null}],wingShapeVariants:[{name:`Wings_Long`,object:null},{name:`Wings_Medium`,object:null},{name:`Wings_Short`,object:null}],eyeColor:null,bodyColor:null,brushColor:null},{set(e,t,n){let r=e[t];return e[t]=n,r!==n&&Ep(t,n,r),!0}});window.beetleOptions=$;function wp(e,t){e.forEach(e=>{e.object&&(e.object.visible=e.name===t)})}var Tp=null;function Ep(e,t,n){if(e===`eyeShapeName`)wp($.eyeShapeVariants,t);else if(e===`headShapeName`)wp($.headShapeVariants,t);else if(e===`bodyShapeName`){wp($.bodyShapeVariants,t);let e=$.bodyShapeVariants.findIndex(e=>e.name===t),n=$.wingShapeVariants[e];n&&(wp($.wingShapeVariants,n.name),Zp(n.name))}else if(e===`eyeColor`){let e=$.eyeShapeVariants[0].object;if(!e)return;e.material.emissive.set(t)}else if(e===`bodyColor`){if(!Tp)return;Tp.material.emissive.set(t)}}lp.load(`/web-poster-3-module//Beetles.glb`,e=>{let t=e.scene;cp.add(t),console.log(t),Tp=t.getObjectByName(`Head`),t.getObjectByName(`White_Eye`),$.eyeShapeVariants.forEach(e=>{e.object=t.getObjectByName(e.name)}),$.headShapeVariants.forEach(e=>{e.object=t.getObjectByName(e.name)}),$.bodyShapeVariants.forEach(e=>{e.object=t.getObjectByName(e.name)}),$.wingShapeVariants.forEach(e=>{e.object=t.getObjectByName(e.name)}),$.eyeShapeName=$.eyeShapeVariants[0].name,$.headShapeName=$.headShapeVariants[0].name,$.bodyShapeName=$.bodyShapeVariants[0].name,$.bodyColor&&Ep(`bodyColor`,$.bodyColor),$.eyeColor&&Ep(`eyeColor`,$.eyeColor),window.beetleModel=t,window.dispatchEvent(new CustomEvent(`beetle:ready`,{detail:{scene:cp,model:t}}))});var Dp=document.getElementById(`canvas-buttons-wrapper`),Op={get width(){return Dp.offsetWidth},get height(){return Dp.offsetHeight}},kp=new fo(50,Op.width/Op.height,.05,100);cp.add(kp),kp.position.z=-2.5,kp.position.x=-2.5,kp.position.y=3;var Ap=document.querySelector(`.webgl`),jp=new ru({alpha:!0,antialias:!0,canvas:Ap});jp.setPixelRatio(Math.min(window.devicePixelRatio,2)),jp.setSize(Op.width,Op.height),jp.render(cp,kp);var Mp=new pu(kp,Ap);Mp.autoRotate=!0,Mp.autoRotateSpeed=.8,Mp.enableDamping=!0,Mp.enablePan=!1,Mp.target=new W(0,0,0),Mp.enableZoom=!1,window.addEventListener(`resize`,()=>{kp.aspect=Op.width/Op.height,kp.updateProjectionMatrix(),jp.setSize(Op.width,Op.height)});var Np=[{button:document.querySelector(`.anchored-button-eyes`),name:`Eyes`,position:new W(-.33,.71,-.96)},{button:document.querySelector(`.anchored-button-wings`),name:`Wings`,position:new W(-.52,.91,.25)},{button:document.querySelector(`.anchored-button-body-color`),name:`Body Color`,position:new W(-.58,.33,-.34)},{button:document.querySelector(`.anchored-button-head`),name:`Head`,position:new W(0,.53,-1.5)},{button:document.querySelector(`.anchored-button-body-shape`),name:`Body Shape`,position:new W(-.01,.99,1)}];function Pp(){for(let e=0;e<Np.length;e++){let t=Np[e].position.clone();t.project(kp);let n=(t.x*.5+.5)*Op.width,r=(-t.y*.5+.5)*Op.height;Np[e].button.style.left=n+`px`,Np[e].button.style.top=r+`px`}}var Fp=`#ff2d9e`,Ip=10,Lp=512,Rp={Wings_Short:`/web-poster-3-module//Body Short Frame.svg`,Wings_Medium:`/web-poster-3-module//Body Medium Frame.svg`,Wings_Long:`/web-poster-3-module//Body Long Frame.svg`},zp=document.getElementById(`wingP5Container`),Bp=document.getElementById(`wingP5ContainerMobile`),Vp=document.getElementById(`wingMaskOverlay`),Hp=document.getElementById(`wingMaskOverlayMobile`),Up=document.querySelectorAll(`.wing-clear-btn`),Wp,Gp,Kp,qp,Jp,Yp=`#ededed`,Xp=null;function Zp(e){let t=Rp[e];t&&(Vp&&(Vp.src=t),Hp&&(Hp.src=t))}function Qp(){Jp&&$.wingShapeVariants.forEach(e=>{e.object&&(e.object.material=Jp)})}function $p(){Kp&&(Kp.background(Yp),qp&&(qp.needsUpdate=!0))}function em(){return zp&&zp.offsetWidth>0&&zp.offsetHeight>0?zp:Bp&&Bp.offsetWidth>0&&Bp.offsetHeight>0?Bp:null}function tm(){if(!Gp)return;let e=em();if(!e)return;Xp!==e&&(e.appendChild(Gp.elt),Xp=e);let t=Math.max(1,Math.min(e.offsetWidth,e.offsetHeight));Gp.elt.style.width!==t+`px`&&(Gp.elt.style.width=t+`px`,Gp.elt.style.height=t+`px`)}function nm(e){let t=Gp.elt.getBoundingClientRect(),n=Lp/t.width;return{x:(e.clientX-t.left)*n,y:(e.clientY-t.top)*n,scale:n}}function rm(){qp&&qp.dispose(),qp=new ia(Kp.elt),qp.flipY=!1,qp.colorSpace=He,qp.anisotropy=jp.capabilities.getMaxAnisotropy(),qp.needsUpdate=!0,Jp=new Ur({map:qp}),Qp()}function im(){!zp&&!Bp||Wp||(Wp=new e(e=>{e.setup=function(){Gp=e.createCanvas(Lp,Lp);let t=zp||Bp;Gp.parent(t),Xp=t,Kp=e.createGraphics(Lp,Lp),Kp.background(Yp),rm(),Gp.elt.style.touchAction=`none`;let n=!1,r=0,i=0;Gp.elt.addEventListener(`pointerdown`,e=>{n=!0;let t=nm(e);r=t.x,i=t.y,Gp.elt.setPointerCapture(e.pointerId),e.preventDefault()}),Gp.elt.addEventListener(`pointermove`,e=>{if(!n)return;let t=nm(e);Kp.stroke($.brushColor||Fp),Kp.strokeWeight((parseFloat($.brushSize)||Ip)*t.scale),Kp.line(r,i,t.x,t.y),qp.needsUpdate=!0,r=t.x,i=t.y,e.preventDefault()}),[`pointerup`,`pointercancel`,`pointerleave`].forEach(e=>{Gp.elt.addEventListener(e,()=>{n=!1})})},e.draw=function(){tm(),e.image(Kp,0,0)}}))}Up.length&&Up.forEach(e=>e.addEventListener(`click`,$p)),im(),window.addEventListener(`beetle:ready`,()=>{Qp();let e=$.bodyShapeVariants.findIndex(e=>e.name===$.bodyShapeName),t=$.wingShapeVariants[e];t&&Zp(t.name)});var am=null;function om(){jp.render(cp,kp),Mp.update(),am=requestAnimationFrame(om),Pp()}om();var sm=0,cm=0,lm=0,um=0;yp.addEventListener(`mousemove`,e=>{let t=yp.getBoundingClientRect();sm=(e.clientX-t.left)/t.width*2-1,cm=(e.clientY-t.top)/t.height*2-1});var dm=xp.position.clone(),fm=.01,pm=.2,mm=null,hm=Date.now();function gm(e,t){let n=e.userData.baseRotY+sm*t,r=e.userData.baseRotX+cm*t;e.rotation.y+=(n-e.rotation.y)*.1,e.rotation.x+=(r-e.rotation.x)*.1}function _m(){Sp.render(cp,xp),mm=requestAnimationFrame(_m);let e=Date.now(),t=e-hm;hm=e,up.rotation.y+=.001*t,fp.rotation.x=Math.sin(e*.003)*.07,pp.rotation.y=Math.sin(e*.005)*.3,mp.rotation.y=Math.sin(e*.005+1)*.3,hp.rotation.z=Math.sin(e*.001+1)*.05,gm(dp,pm),gm(hp,pm),gm(gp,pm),gm(_p,pm),gm(pp,pm),gm(mp,pm),gm(vp,pm*3),lm=sm*fm,um=-cm*fm,xp.position.x+=(dm.x+lm-xp.position.x)*.1,xp.position.y+=(dm.y+um-xp.position.y)*.1,xp.lookAt(0,0,-1)}_m();var vm=document.getElementById(`creation-section`);vm&&`IntersectionObserver`in window&&new IntersectionObserver(([e])=>{e.isIntersecting?am===null&&om():am!==null&&(cancelAnimationFrame(am),am=null)},{threshold:.05}).observe(vm);var ym=document.getElementById(`hero-section`);ym&&`IntersectionObserver`in window&&new IntersectionObserver(([e])=>{e.isIntersecting?mm===null&&_m():mm!==null&&(cancelAnimationFrame(mm),mm=null)},{threshold:.05}).observe(ym);